...
/**
 * Command class that implements that implement the redComponent Command used by the controller.
 */
public class RedComponent implements Command {
  ...
  /**
   * Public constructor class for the redComponent command.
   */
  public RedComponent(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.splitImageByRGB(inputArray.get(1), inputArray.get(2), "", "", percentage);
