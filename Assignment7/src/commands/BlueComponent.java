...
/**
 * Command class that implements that implement the Blue Command used by the controller.
 */
public class BlueComponent implements Command {
  ...
  /**
   * Public constructor class for the BlueComponent command.
   */
  public BlueComponent(List<String> inputArray) {
    maskArgument = "";
