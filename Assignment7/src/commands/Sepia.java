...
/**
 * Command class that implements that implement the Sepia Command used by the controller.
 */
public class Sepia implements Command {
  ...
  /**
   * Public constructor class for the Sepia command.
   */
  public Sepia(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.createSepiaTonedImage(inputArray.get(1), inputArray.get(2), percentage);
