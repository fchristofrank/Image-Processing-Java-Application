...
/**
 * Command class that implements that implement the Green Command used by the controller.
 */
public class GreenComponent implements Command {
  ...
  /**
   * Public constructor class for the GreenComponent command.
   */
  public GreenComponent(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.splitImageByRGB(inputArray.get(1), "", inputArray.get(2), "",
        percentage);
