...
/**
 * Command class that implements that implement the Sharpen Command used by the controller.
 */
public class Sharpen implements Command {
  ...
  /**
   * Public constructor class for the Sharpen command.
   */
  public Sharpen(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.createSharpenedImage(inputArray.get(1), inputArray.get(2), percentage);
