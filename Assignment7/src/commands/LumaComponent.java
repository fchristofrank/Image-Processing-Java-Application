...
/**
 * Command class that implements that implement the LumaComponent Command used by the controller.
 */
public class LumaComponent implements Command {
  ...
  /**
   * Public constructor class for the LumaComponent command.
   */
  public LumaComponent(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.createLumaImage(inputArray.get(1), inputArray.get(2), percentage);
