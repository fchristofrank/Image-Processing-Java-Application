...
/**
 * Command class that implements that implement the Blur Command used by the controller.
 */
public class Blur implements Command {
  ...
  /**
   * Public constructor class for the Blur command.
   */
  public Blur(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.createBlurredImage(inputArray.get(1), inputArray.get(2), percentage);
