...
/**
 * Command class that implements that implement the IntensityComponent Command used by the
 * controller.
 */
public class IntensityComponent implements Command {
  ...
  /**
   * Public constructor class for the IntensityComponent command.
   */
  public IntensityComponent(List<String> inputArray) {
  ...
  public void run(CustomModel model) {
    model.createIntensityImage(inputArray.get(1), inputArray.get(2), percentage);
