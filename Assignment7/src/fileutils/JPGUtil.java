...
/**
 * This class handles all behaviours associated with JPG images and implements the FileUtil
 * interface.
 */
public class JPGUtil implements FileUtil {
   ...
   */
  @Override
  public boolean writeCustomImageToFile(CustomImage image, File file)
      throws IOException {
    int height = image.getHeight();
    int width = image.getWidth();
