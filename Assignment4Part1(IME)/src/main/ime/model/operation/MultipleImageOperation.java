...
public interface MultipleImageOperation {
  ...
  /**
   * Applies the operation to a list of images and returns the resulting image.
   * Each implementation defines the specific operation to be performed on the images.
   * The method may throw an IllegalArgumentException if the input images or arguments are invalid,
