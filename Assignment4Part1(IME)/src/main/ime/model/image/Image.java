...
/**
 * Represents an image with pixel manipulation capabilities.
 * This interface defines the fundamental operations that can be performed on an image,
 * including retrieving and modifying pixel data, applying operations, and obtaining
...
public interface Image {
   ...
   * @param args      optional arguments for the operation.
   * @return a new Image instance that results from applying the operation.
   * @throws IllegalArgumentException if the operation cannot be applied or if the arguments
   *                                  are invalid.
   */
