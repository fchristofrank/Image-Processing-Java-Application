...
public class ImageOperationTest {
  ...
  public void testMultipleOperationsPNG() {
    ...
    commandScript.append("vertical-flip").append(" ").append("boston-rgb-horizontal").append(" ")
            .append("boston-rgb-horizontal-vertical").append("\n");
    ...
    commandScript.append("intensity-component").append(" ").append("boston").append(" ")
            ...
            append("save").append(" ").append(resDirPath).append("boston-rgb-actual.png")
  ...
  public void testMultipleOperationsJPG() {
    ...
    commandScript.append("intensity-component").append(" ").append("boston").append(" ")
            .append("boston-intensity").append("\n").
            append("save").append(" ").append(resDirPath).append("boston-rgb-actual.jpg")
            .append(" ").append("boston-rgb")
            .append("\n");
  ...
  public void testMultipleOperationsPPM() {
    String resDirPath = Objects.requireNonNull(getClass().getClassLoader()
            .getResource("")).getPath();
    StringBuilder commandScript = new StringBuilder();
    commandScript.append("load").append(" ").append(resDirPath).append("boston.ppm").append(" ")
            .append("boston");
    commandScript.append("\n");
    commandScript.append("red-component").append(" ").append("boston").append(" ")
            .append("boston-red").append("\n");
    ...
    commandScript.append("intensity-component").append(" ").append("boston").append(" ")
            .append("boston-intensity").append("\n").
            append("save").append(" ").append(resDirPath).append("boston-rgb-actual.ppm")
            .append(" ").append("boston-rgb")
            .append("\n");
    ...
    Image actualRGBImage;
    try {
      actualRGBImage = imageReader.read(resDirPath + "boston.ppm",
              ImageType.RGB);
    } catch (IOException e) {
      throw new IllegalArgumentException("Failed to read image file", e);
    }
